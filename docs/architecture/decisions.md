...
| ADR-015 | proposed | Draft decision: internal Grafana service dashboards give platform/service roles all-tenant system statistics and filtered telemetry point graphs; tenant-facing dashboards require separate tenant isolation. | `adrs/ADR-015-internal-grafana-service-telemetry-dashboard.md` | n/a |
