...
(
    ...
    source_id String,
    point_key String,
    point_id_state AggregateFunction(argMax, String, DateTime64(3, 'UTC')),
    point_ref_state AggregateFunction(argMax, String, DateTime64(3, 'UTC')),
    source_config_revision_state AggregateFunction(argMax, String, DateTime64(3, 'UTC')),
    value_type_state AggregateFunction(argMax, String, DateTime64(3, 'UTC')),
    quality_state AggregateFunction(argMax, String, DateTime64(3, 'UTC')),
...
AS SELECT
    ...
    source_id,
    point_key,
    argMaxState(toString(point_id), ts) AS point_id_state,
    argMaxState(toString(point_ref), ts) AS point_ref_state,
    argMaxState(toString(source_config_revision), ts) AS source_config_revision_state,
    argMaxState(toString(value_type), ts) AS value_type_state,
    argMaxState(toString(quality), ts) AS quality_state,
