...
- Keep JSON Schema validation aligned with `docs/contracts/wm-edge-agent`.
- Update Config Registry docs when API, backoffice, outbox, or persistence
  behavior changes.

## Do Not

- Do not rename `wm_config_registry` or `wm-config-registry`.
