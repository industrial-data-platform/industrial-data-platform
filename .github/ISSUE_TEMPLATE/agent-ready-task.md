...
about: Create a scoped implementation issue that an AI agent can take into work
title: ""
labels: ""
assignees: ""
---
...
7. Do not:
   - TBD
8. If a blocker, source-of-truth conflict, or breaking compatibility change is
   discovered, stop and ask for confirmation before implementation.
...
- TBD
- Docs/contracts/LikeC4/ADR/README/runbooks are updated, or explicitly recorded
  as intentionally unchanged with rationale.
...
- Validation passed:
- Docs/contracts/LikeC4/ADR/README/runbooks:
